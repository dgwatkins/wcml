...
class WCML_Table_Rate_Shipping{
    ...
    function init(){
        ...
        if($pagenow == 'admin.php' && isset($_GET['page']) && $_GET['page']=='shipping_zones' && isset( $_POST['shipping_label'] ) && isset( $_POST['woocommerce_table_rate_title'] )){
            apply_filters('register_string_for_translation', 'woocommerce', $_POST['woocommerce_table_rate_title'] .'_shipping_method_title', $_POST['woocommerce_table_rate_title']);
            $shipping_labels = array_map( 'woocommerce_clean', $_POST['shipping_label'] );
            foreach($shipping_labels as $shipping_label){
                apply_filters('register_string_for_translation', 'woocommerce', $shipping_label .'_shipping_method_title', $shipping_label);
            }
        }
