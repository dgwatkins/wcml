...
class WCML_Extra_Product_Options{
    ...
    function inf_message( $text ){
        ...
        $message .= sprintf(__('To translate Extra Options strings please save %s and go to the <b><a href="%s">String Translation interface</a></b>', 'wpml-wcml'), $text, admin_url('admin.php?page=wpml-string-translation/menu/string-translation.php&context=wc_extra_product_options'));
        $message .= '</p></div>';
