...
class WCML_Product_Addons{
    ...
    function inf_translate_strings(){
        ...
        $message .= sprintf(__('To translate Add-ons strings please save Add-ons and go to the <b><a href="%s">String Translation interface</a></b>', 'wpml-wcml'), admin_url('admin.php?page=wpml-string-translation/menu/string-translation.php&context=wc_product_addons_strings'));
        $message .= '</p></div>';
