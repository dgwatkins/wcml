...
class WCML_Ajax_Layered_Nav_Widget {
	function __construct() {
		...
		add_filter('wc_ajax_layered_nav_query_editor', array($this, 'wc_ajax_layered_nav_query_editor_fun'),10,2);
	}
...
function wc_ajax_layered_nav_query_editor_fun($attribute,$value){
	$posts = get_posts(
		array(
			'post_type' 	=> 'product',
			'numberposts' 	=> -1,
