            ...
            <div class="wcml-section-content">
                <ul>
                     <?php if (defined('ICL_SITEPRESS_VERSION') && version_compare(ICL_SITEPRESS_VERSION, '2.0.5', '<')) : ?>
	                     <li>
		                     <i class="otgs-ico-warning"></i> <?php printf( __( 'WooCommerce Multilingual is enabled but not effective. It is not compatible with  <a href="%s">WPML</a> versions prior 2.0.5.', 'wpml-wcml' ), $woocommerce_wpml->generate_tracking_link( 'http://wpml.org/' ) ); ?>
		                     <a href="<?php echo $woocommerce_wpml->generate_tracking_link( 'http://wpml.org/shop/account/', false, 'account' ) ?>"
		                        target="_blank"><?php _e( 'Update WPML', 'wpml-wcml' ); ?></a></li>
                    ...
                    <?php else : ?>
	                     <li>
		                     <i class="otgs-ico-warning"></i> <?php printf( __( '%s plugin is either not installed or not active.', 'wpml-wcml' ), '<strong>WPML</strong>' ); ?>
		                     <a href="<?php echo $woocommerce_wpml->generate_tracking_link( 'http://wpml.org/' ) ?>"
		                        target="_blank"><?php _e( 'Get WPML', 'wpml-wcml' ); ?></a></li>
                    <?php endif; ?>
                    ...
                    <?php else : ?>
	                    <li>
		                    <i class="otgs-ico-warning"></i> <?php printf( __( '%s plugin is either not installed or not active.', 'wpml-wcml' ), '<strong>WPML Media</strong>' ); ?>
		                    <a href="<?php echo $woocommerce_wpml->generate_tracking_link( 'http://wpml.org/' ) ?>"
		                       target="_blank"><?php _e( 'Get WPML Media', 'wpml-wcml' ); ?></a></li>
                    <?php endif; ?>
                    ...
                    <?php else : ?>
	                    <li>
		                    <i class="otgs-ico-warning"></i> <?php printf( __( '%s plugin is either not installed or not active.', 'wpml-wcml' ), '<strong>WPML Translation Management</strong>' ); ?>
		                    <a href="<?php echo $woocommerce_wpml->generate_tracking_link( 'http://wpml.org/' ) ?>"
		                       target="_blank"><?php _e( 'Get WPML Translation Management', 'wpml-wcml' ); ?></a></li>
                    <?php endif; ?>
                    ...
                    <?php else : ?>
	                    <li>
		                    <i class="otgs-ico-warning"></i> <?php printf( __( '%s plugin is either not installed or not active.', 'wpml-wcml' ), '<strong>WPML String Translation</strong>' ); ?>
		                    <a href="<?php echo $woocommerce_wpml->generate_tracking_link( 'http://wpml.org/' ) ?>"
		                       target="_blank"><?php _e( 'Get WPML String Translation', 'wpml-wcml' ); ?></a></li>
                    <?php endif; ?>
                    <?php
                    global $woocommerce;
                    if (class_exists('Woocommerce') && $woocommerce && isset($woocommerce->version) && version_compare($woocommerce->version, '2.0', '<')) :
                        ?>
	                    <li>
		                    <i class="otgs-ico-warning"></i> <?php printf( __( '%1$s  is installed, but with incorrect version. You need %1$s %2$s or higher. ', 'wpml-wcml' ), '<strong>WooCommerce</strong>', '2.0' ); ?>
		                    <a href="http://wordpress.org/extend/plugins/woocommerce/"
		                       target="_blank"><?php _e( 'Download WooCommerce', 'wpml-wcml' ); ?></a></li>
                    ...
                    <?php else : ?>
	                    <li>
		                    <i class="otgs-ico-warning"></i> <?php printf( __( '%s plugin is either not installed or not active.', 'wpml-wcml' ), '<strong>WooCommerce</strong>' ); ?>
		                    <a href="http://wordpress.org/extend/plugins/woocommerce/"
		                       target="_blank"><?php _e( 'Download WooCommerce', 'wpml-wcml' ); ?></a></li>
                    <?php endif; ?>
                </ul>
