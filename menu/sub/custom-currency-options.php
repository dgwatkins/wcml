	...
	<form class="wcml_currency_options" action="" method="">
		...
		<div class="wpml-dialog-body">
			...
			<div class="wpml-form-row">
				...
				<select name="currency_options[position]">
			...
			<div class="wpml-form-row">
				...
				<input name="currency_options[thousand_sep]" type="text"
					   class="currency_option_input" value="<?php echo esc_attr( $args['currency']['thousand_sep'] ) ?>"/>
			</div>
			<div class="wpml-form-row">
				<label
				...
				<input name="currency_options[decimal_sep]" type="text"
					   class="currency_option_input" value="<?php echo esc_attr( $args['currency']['decimal_sep'] ) ?>"/>
			</div>
			<div class="wpml-form-row">
				<label
					for="currency_options[num_decimals]"><?php _e( 'Number of Decimals', 'woocommerce-multilingual' ) ?></label>
				<input name="currency_options[num_decimals]" type="number" class="decimals_number"
