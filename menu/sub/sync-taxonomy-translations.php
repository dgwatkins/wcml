<div class="icl_tt_main_bottom" style="display: none;">
    ...
    <?php else:
        ...
        <p id="wcml_tt_sync_desc" style="<?php echo $display; ?>"><?php printf( __( 'This action lets you automatically apply the %s taxonomy to your content in different  languages. It will scan the original content and apply the same taxonomy to translated content.', 'woocommerce-multilingual' ), '<i>' . $taxonomy_obj->labels->singular_name . '</i>' ); ?></p>
