...
class Test_WCML_Exchange_Rates_Ajax extends WP_Ajax_UnitTestCase {
    ...
    public function test_update_exchange_rates_ajax(){
        ...
        $exchange_rate_service_yahoo = $this->getMockBuilder( 'WCML_Exchange_Rates_YahooFinance' )
        ...
        $exchange_rate_service_yahoo->method( 'get_rates' )->willReturn( $rates );

        $this->exchange_rate_services->add_service( 'yahoo', $exchange_rate_service_yahoo );
