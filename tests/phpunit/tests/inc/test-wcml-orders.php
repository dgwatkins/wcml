...
class Test_WCML_Orders extends OTGS_TestCase {
	...
	public function get_woocommerce_order_items_mock( $language, $order ){
		...
		$product_item = $this->getMockBuilder( 'WC_Order_Item_Product' )
		                     ->disableOriginalConstructor()
		                     ->setMethods( array( 'get_type', 'get_product_id', 'get_variation_id', 'set_variation_id', 'set_product_id', 'get_meta_data', 'update_meta_data', 'set_name' ) )
		                     ->getMock();
		...
		$shipping_item = $this->getMockBuilder( 'WC_Order_Item_Shipping' )
		                      ->disableOriginalConstructor()
		                      ->setMethods( array( 'get_method_id', 'get_instance_id', 'get_method_title', 'set_method_title' ) )
		                      ->getMock();
