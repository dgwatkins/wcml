...
/**
 * Class Test_WCML_Product_Image_Filter_Factory
 * @group product-media
 */
class Test_WCML_Product_Image_Filter_Factory extends OTGS_TestCase {
	...
	public function it_should_create_the_object() {
		...
		$this->assertInstanceOf( 'WCML_Product_Image_Filter', $factory->create() );
	}
