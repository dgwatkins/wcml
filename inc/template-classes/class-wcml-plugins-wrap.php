...
class WCML_Plugins_Wrap extends WPML_Templates_Factory {
    ...
    public function get_model(){
        ...
        $model = array(
            ...
            'tracking_link' => $this->woocommerce_wpml->generate_tracking_link( 'https://wpml.org/shop/account/', false, 'account' ),
            ...
            'strings' => array(
                ...
                'old_wpml_link'=> sprintf( __( 'WooCommerce Multilingual is enabled but not effective. It is not compatible with  <a href="%s">WPML</a> versions prior 2.0.5.', 'woocommerce-multilingual' ), $this->woocommerce_wpml->generate_tracking_link( 'https://wpml.org/' ) ),
                ...
                'new_design_wpml_link'=> sprintf( __( 'You are using WooCommerce Multilingual %s. This version includes an important UI redesign for the configuration screens and it requires <a href="%s">WPML %s</a> or higher. Everything still works on the front end now but, in order to configure options for WooCommerce Multilingual, you need to upgrade WPML.', 'woocommerce-multilingual' ), WCML_VERSION, $this->woocommerce_wpml->generate_tracking_link( 'https://wpml.org/' ), '3.4' ),
                ...
                'wpml_not_inst' => sprintf( __( '%s is either not installed or not active.', 'woocommerce-multilingual' ),'<strong><a title="' . esc_attr__('The WordPress Multilingual Plugin', 'woocommerce-multilingual') .'" href="' . $this->woocommerce_wpml->generate_tracking_link( 'https://wpml.org/' ) . '">WPML</a></strong>' ),
