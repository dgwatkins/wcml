    ...
    public function get_model() {
        ...
        $model = array(
            ...
            'strings' => array(
                ...
                'def_and_st_not_en' => esc_html__( "Your site's default language is not English and the strings language is also not English.", 'woocommerce-multilingual' ),
                ...
                'def_not_en' => esc_html__( "Your site's default language is not English.", 'woocommerce-multilingual' ),
