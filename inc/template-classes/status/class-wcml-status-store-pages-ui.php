    ...
    public function get_model() {
        ...
        $model = array(
            ...
            'strings' => array(
                ...
                'pages_trnsl' => __( 'To run a multilingual e-commerce site, you need to have the WooCommerce shop pages translated to all the site&#8217s languages. Once all the pages are installed you can add the translations for them from this menu.', 'woocommerce-multilingual' ),
                'store_pages' => __( 'WooCommerce Store Pages', 'woocommerce-multilingual' ),
                ...
                'translated' => __( 'WooCommerce store pages are translated to all the site&#8217s languages.', 'woocommerce-multilingual' )
            ),
            'nonces' => array(
