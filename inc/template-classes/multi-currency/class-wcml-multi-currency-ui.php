...
class WCML_Multi_Currency_UI extends WCML_Templates_Factory {
	...
	public function __construct( $woocommerce_wpml, $sitepress ) {
		...
		$functions = [
			...
			new Twig_SimpleFunction( 'is_currency_on', [ $this, 'is_currency_on' ] ),
			new Twig_SimpleFunction( 'get_language_currency', [ $this, 'get_language_currency' ] ),
			new Twig_SimpleFunction( 'get_currency_symbol', [ $this, 'get_currency_symbol' ] ),
			new Twig_SimpleFunction( 'get_currency_name', [ $this, 'get_currency_name' ] ),
		...
		$model = [
			'strings'                => [
				...
				'currencies_table'    => [
					...
					'enable_for'       => __( 'Enable %1$s for %2$s', 'woocommerce-multilingual' ),
					'disable_for'      => __( 'Disable %1$s for %2$s', 'woocommerce-multilingual' ),
				],
