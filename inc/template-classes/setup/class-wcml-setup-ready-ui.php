    ...
    public function get_model(){
        ...
        $model = array(
            'strings' => array(
                ...
                'description2'  => esc_html__("For your convenience, we've marked items that require your attention with a notice icon. You can see a list of everything that you should complete in the %sStatus%s tab.", 'woocommerce-multilingual'),
