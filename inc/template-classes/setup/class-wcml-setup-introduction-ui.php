...
class WCML_Setup_Introduction_UI extends WPML_Templates_Factory {
    ...
    public function get_model(){
        ...
        $model = array(
            'strings' => array(
                'heading'       => esc_html__("Let's turn your WooCommerce shop multilingual", 'woocommerce-multilingual'),
                ...
                'description2'   => array(
                	...
                	'title' => esc_html__("We'll help you:", 'woocommerce-multilingual'),
                ...
                'continue'      => esc_html__("Let's continue", 'woocommerce-multilingual'),
                'later'         => esc_html__("I'll do the setup later", 'woocommerce-multilingual')
            ),
