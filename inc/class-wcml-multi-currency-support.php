...
class WCML_Multi_Currency_Support{
    ...
    function init(){
        ...
        if(defined('W3TC')){
            $this->WCML_W3TC_Multi_Currency = new WCML_W3TC_Multi_Currency;
        }
    ...
    function add_currency( $currency_code ){
    ...
    function save_currency(){
        ...
        if( !isset($this->currencies[$currency_code]) ){
            $this->add_currency( $currency_code );
        }
    ...
    function load_inline_js(){
        ...
        if(isset($this->WCML_W3TC_Multi_Currency)){
            $script_vars['w3tc'] = 1;
        }
