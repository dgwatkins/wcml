...
//        }
    ...
    */
    ...
    function update_product_actions() {
        ...
        $this->get_translation_statuses( $original_product_id, $translations, $languages, isset($_POST['slang']) && $_POST['slang'] != 'all'?$_POST['slang']:false, $product_trid, $job_id ? $language : false );
