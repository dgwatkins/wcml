    ...
    public static function admin_notice_after_install(){
        ...
        if( !$woocommerce_wpml->settings['dismiss_doc_main'] ){
            ...
            <div id="message" class="updated message fade otgs-is-dismissible">
                <p>
                    <?php printf(__('You&#8217ve successfully installed %sWooCommerce Multilingual%s. Would you like to see a quick overview?', 'woocommerce-multilingual'), '<strong>', '</strong>'); ?>
                </p>
                <p>
